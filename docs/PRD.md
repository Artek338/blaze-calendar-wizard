...
**Phase 4: Preview & Validation (Week 6)**
...
**Phase 6: QA & Beta (Week 8)**
- Internal QA testing
- Beta rollout to 10-20 users (Kasia/Tomek personas)
...
**Week 10: Beta Launch (5% → 20%)**
- Enable for beta user group:
  - 10 healthcare coordinators (Kasia persona)
  - 5 hospital IT admins (Tomek persona)
- Send personalized onboarding emails
- Schedule feedback calls (30-min each)
- Iterate based on feedback

**Week 11: Gradual Rollout (20% → 50%)**
- Enable for 50% of new Calendar widget users
- A/B test: Wizard (50%) vs Manual Config (50%)
- Compare metrics:
...
**Week 12: Full Rollout (50% → 100%)**
- Enable wizard for 100% of users
- Keep "Skip wizard" option visible (20% expected usage)
- Send platform-wide announcement:
  - Email newsletter
  - In-app notification
  - Blog post: "Introducing Calendar Wizard"

**Week 13+: Post-Launch Optimization**
- Monitor North Star Metric: "Users with working calendar (no timezone errors) in 7 days"
- Iterate on wizard based on analytics:
  - Where do users abandon? (funnel analysis)
  - Which validation errors are most common?
  - Are users using test booking? (>60% target)
...
**Research Documents:**
- Research Report: `C:\Users\artur\Desktop\Projekty\claude-pm-workflow\projects\blaze-calendar-wizard\docs\RESEARCH_REPORT.md`
- Problem Prioritization: `C:\Users\artur\Desktop\Projekty\claude-pm-workflow\projects\blaze-calendar-wizard\docs\PROBLEM_PRIORITIZATION.md`
- Wizard Flow Design: `C:\Users\artur\Desktop\Projekty\claude-pm-workflow\projects\blaze-calendar-wizard\docs\WIZARD_FLOW.md`
